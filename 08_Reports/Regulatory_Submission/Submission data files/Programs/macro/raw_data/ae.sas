...
PROC IMPORT OUT=temp
     DATAFILE="C:\Users\hed2\Downloads\sas practice\SAS-Clinical-Trials-Toolkit-master2\SAS-Clinical-Trials-Toolkit-master/ae.xlsx"
     DBMS=XLSX REPLACE;
     getnames=NO;
     sheet='Sheet1';
RUN;
