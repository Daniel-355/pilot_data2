*---------------------------------------------------------;
* Macro for deriving ABLFL, BASE, CHG, and PCHG 
for a BDS  formatted ADaM data set;
* Assumes baseline is the last non-missing value on or before study day 1 and that 
the INDDATA is an SDTM data set with  variables USUBJID and VISITNUM
*---------------------------------------------------------;
